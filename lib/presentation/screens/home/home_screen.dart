    ...
    return ListView(
      children: const [
        _CustomListTile(
            ...
            subTitle: 'A reading-only provider',
            location: '/provider'),
        _CustomListTile(
            title: 'Provider + Go_Router',
            subTitle: 'An applied use',
        ...
        _CustomListTile(
            ...
            subTitle: 'Maintain the state of a Stream and its emotions',
            location: '/stream-provider'),
        _CustomListTile(
            title: 'State Notifier Provider',
            subTitle: 'Provider with automatic notification',
            location: '/state-notifier-provider'),
        _CustomListTile(
            title: 'Change Notifier Provider',
            subTitle: 'Provider with notification control to listeners',
